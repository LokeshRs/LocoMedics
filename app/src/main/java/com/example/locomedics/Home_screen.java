    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference db_ref= firebaseDatabase.getReference();
                DatabaseReference db_child=db_ref.child("0");
                DatabaseReference db_sub =db_child.child("Med_discription");
                db_sub.addValueEventListener(new ValueEventListener() {
                    @Override
